...
export default function CartIcon() {
    ...
    if (!hydrated) {
        return (
            <button className="flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-800 text-white">
    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-800 text-white hover:bg-emerald-700 transition cursor-pointer"
            >
                <FaShoppingCart className="text-lg" />
